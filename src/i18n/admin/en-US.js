export const m = {
  ...
  // Problem.vue
  Add_Problem: 'Generate and Depoly Problem',
  ...
  Score: 'Score',
  Hint: 'Hint',
  Hint_Placeholder: 'hint for student',
  Source: 'Source',
  ...
  New_Tag: 'New Tag',
  Prob_Score: 'Score',
  Prob_File: 'Problem Source Code for Build',
  Build_Options: 'Build Flags (optional)',
  Build_Options_Desc: '-g -O0',
  Mitigations: 'Mitigations to Apply',
  Build_Template: 'Build File Template',
  Knowledge_Type_Auditing: 'Knowledge Type (audit language)',
  Lang_Default: 'None',
  Lang_C: 'C',
  Lang_CPP: 'C++',
  Knowledge_Type_Ep1: 'Required Knowledge Type',
  Skill_Type_Ep1: 'Required Skill Type',
  Knowledge_Type_Ep2: 'Required Knowledge Type',
  Skill_Type_Ep2: 'Required Skill Type',
  Knowledge_Type_Ep3: 'Required Knowledge Type',
  Skill_Type_Ep3: 'Required Skill Type',
  Knowledge_Type_Ep4: 'Required Knowledge Type',
  Skill_Type_Ep4: 'Required Skill Type',
